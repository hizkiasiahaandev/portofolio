        ...
        <section id="contact" className="bg-slate-950 px-4 py-16">
            <div className="max-w-7xl mx-auto space-y-10">
                <div className="flex flex-wrap items-start justify-between gap-8">
                    <div className="space-y-6 max-w-xl" data-aos="fade-down">
                    ...
                    <div className="w-full max-w-lg rounded-lg border border-slate-700 bg-slate-900/80 p-8 shadow-2xl shadow-slate-950/50 backdrop-blur-sm" data-aos="fade-up">
                ...
                <div className="pt-8 mt-8 border-t border-slate-800" data-aos="fade-right">
